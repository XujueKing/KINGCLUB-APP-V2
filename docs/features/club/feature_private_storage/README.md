...
查看会员存酒/物品并展示服务端签发的取件凭证。

## 本期包含

- [KC-P-047 私人储物柜页](pages/page_private_storage/README.md) — `Draft`
- [KC-P-048 存酒/物品取件码页](pages/page_storage_pickup_code/README.md) — `Draft`

## 本期不包含

员工扫码交付和库房管理移出消费者 App。
