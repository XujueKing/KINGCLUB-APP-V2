...
- 当前 Mock 主套餐保留 `2026-08-29 周六 20:30-04:00`、`3880卡座套餐`、10 人套餐和报价内容；预订前不再展示 `V5` 或任何卡座号，主视觉改为“随机卡座 / 前一天揭晓”。
- 套餐海报使用从用户提供的原版截图提取的完整海报资产 `assets/legacy/aa/package_3880_v1.png`，禁止再用 King Logo、占位图或代码绘图替代。
- 页头使用“一起玩套餐”；随机分配说明、日期、海报、套餐名、双列内容和价格按原纵向密度展示。
...
- 不增加常驻测试按钮，长按“一起玩套餐”标题打开本地验收状态面板。
