...
- [KC-P-015 添加好友入口页](pages/page_add_friend/README.md) — `Approved for Development`
- [KC-P-016 好友申请列表页](pages/page_friend_requests/README.md) — `Approved for Development`
- [KC-P-018 发送好友申请页](pages/page_send_friend_request/README.md) — `Approved for Development`
...
本包已通过文档准入；全部 48 页批准前不创建 Flutter UI，全局 UI Flow Approved 前不连接真实接口、相机或 WebSocket。
