...
- [KC-P-015 添加好友/扫码页](pages/page_add_friend/README.md) — `Draft`
- [KC-P-016 好友申请列表页](pages/page_friend_requests/README.md) — `Draft`
- [KC-P-018 发送好友申请页](pages/page_send_friend_request/README.md) — `Draft`
