...
**2026-09-10 最新需求**：[22 条碎片需求与范围变更](../product/2026-09-09-native-product-review/REQUIREMENT_INBOX.md)已关联 PR-01～41。首版不做实名核身，沿用旧照片上传接口方法；创作/美颜、游戏大厅、储物券/道具和 App 授权管理能力纳入完整产品。下方批准计数是原基线，新规格尚待拆分/重审，不能据旧排除项删需求。

**2026-09-09 当前任务**：用户要求重新梳理完整原生产品并允许重构旧实现，评审入口见[产品与迁移评审包](../product/2026-09-09-native-product-review/README.md)。下方 48 页是已批准的原 UI/Mock 基线，不代表完整群聊、发布/音乐、真实资产交易已被最终排除；新范围仍待检阅，批准后再逐功能更新本目录契约。

## 当前 M0 范围

- **已确认事实**：本期消费者 Flutter App 已冻结 48 个逻辑页面，完整账本见 [App 范围、页面覆盖与 UI 交付门禁](../v2/APP_SCOPE_AND_UI_DELIVERY_GATE.md)。
- 功能数量、批准状态与新增聊天扩展统一以[唯一覆盖账本](../v2/APP_SCOPE_AND_UI_DELIVERY_GATE.md)为准，不在本索引重复维护状态计数。
- 48 个页面均已拥有独立目录，并于 2026-08-26 全部达到 `Approved for Development`，无 `Draft` 或 `In Review` 页面。
