...
最新：顶部左“二维码＋经验值”上推换昵称，设置在右侧常驻。服务行更新为五项“初次碰碰／我的订单／我的预约／创作者中心／专属客服”，使用用户给的SVG并缩小实际图形，覆盖下方四列旧PNG说明。

最新补充：作品页签上方为四个等宽图文入口“我的订单／我的预约／创作者中心／专属客服”；全部旧PNG。订单移出资产行，资产恢复旧版4rpx纵向内边距与20rpx圆角，不再采用下方历史34dp高度。详见本功能2026-09-12-native-profile.md后续记录。

## 2026-09-12 当前旧小程序还原（优先于下方历史标尺）

用户要求以本机当前旧小程序恢复 UI，并改用原生滚动。详见[实施与验证](../../2026-09-12-native-profile.md)。封面400rpx、头像起点260rpx、统计数字名称横排；默认作品，PageView切换，工具条与页签原生Sliver吸顶。重复点击“我的”平滑回顶。保留用户已加的订单胶囊，同资产入口最小34dp、字体12dp；大字可增高换行。下方540rpx封面、纵向统计、默认动态是旧历史，不再作为当前验收依据。
