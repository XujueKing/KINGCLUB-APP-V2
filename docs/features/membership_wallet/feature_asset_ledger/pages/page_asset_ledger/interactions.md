...
| 长按标题 | 打开仅开发环境可见的 ASSET-M01～M20 Fake 场景选择器 |
| 快速重复触底 | 同一 cursor 只发起一次 Fake 加载，不重复追加 |
| 加载更多失败 | 保留已有流水并在列表底部提供“重试加载” |
| 点击未知条目 | 只展开“状态更新中”，不推断金额、订单或业务类型 |
