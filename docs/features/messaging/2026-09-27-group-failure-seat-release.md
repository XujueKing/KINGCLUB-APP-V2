...
后续 analyze 两个变更文件通过。包含本修复和中文提示的 profile 包完成构建及核心库检查，SHA256 `05DE6B5F5451EAA5A37D5ADA0574CA054094922586D45117A71FDE936BB62C30`。A 覆盖安装成功并恢复已登录首页，B 保留给用户完成正式包登录，尚未覆盖本次增量。真实群媒体及退出仍待双机验证。
