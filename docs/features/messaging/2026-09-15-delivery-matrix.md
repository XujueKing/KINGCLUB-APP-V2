...
## 2026-09-16 通讯录离线头像未通过

A 断网冷重启后，联系人名单、性别及字母分组保留，但真人头像变成默认头像。已定位资料请求失败导致无法读取图片内容键；不能把磁盘图片缓存算作离线头像交付。网络已恢复，修复待完成。详见 `2026-09-16-contact-offline-avatar-gap.md`。
