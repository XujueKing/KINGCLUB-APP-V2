...
> 历史讨论保留。2026-09-09 用户已明确混包中只有 k_/K_ 表属于 KING CLUB，当前[数据/API 迁移评审](../product/2026-09-09-native-product-review/DATA_AND_API_MIGRATION.md)以酒吧接口分类和实际依赖交叉核对。新服务已有 U...账号/独立库方向，以下 personId/多 schema 仅是早期建议；不得复制整库、迁移其他网站数据或据此执行 SQL。
