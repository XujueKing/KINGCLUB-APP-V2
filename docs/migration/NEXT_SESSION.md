...
3. 下一组按首页 KC-P-011 与安全扫码 KC-P-012 完成产品、状态、交互、Fake 契约和验收文档；随后按 profile → social/messaging → club/commerce → wallet/content 顺序逐项完成。networking、session/persistence、observability 只定义 App 端 port、Fake 和未来 adapter 契约。
