...
void main() {
    ...
    final repository = MessagingRepository(
      ...
      call: (id, params) async {
        ...
        return {
          ...
          'status': 'pending',
          'upload': {
            'path': '/kingclub/chat-voice-upload',
  ...
  test('session invalidation prevents requests and oversized input never starts upload', () async {
    ...
    await expectLater(
      uploader.upload(Uint8List(2 * 1024 * 1024 + 1)),
      throwsArgumentError,
    );
    expect(calls, 0);
