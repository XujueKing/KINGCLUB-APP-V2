...
void main() {
  sqfliteFfiInit();
  test(
    'single deletion erases all bound nearby copies across restart',
    () async {
      ...
      for (final member in ['friend', 'other']) {
        ...
        await store.commit('direct:$member', [
          {
      ...
      await store.clear('direct:friend', deletedMessageIds: {'server-friend'});
      await store.close();
