...
void main() {
  ...
  for (final scenario in ['resume', 'corrupt-cache', 'revoked', 'leave-page']) {
    test(
      'encrypted file resume across downloader recreation: $scenario',
      () async {
        ...
        await expectLater(
          ...
          throwsA(
            scenario == 'leave-page' ? isA<AuthFailure>() : isA<DioException>(),
          ),
        );
