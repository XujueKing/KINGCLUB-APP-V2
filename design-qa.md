...
# 2026-09-12 合并说明（优先于以下历史记录）

远端3e2c6e5个人中心/法律页面与本地储物分支合并。保留五按钮底栏及媒体缓存清理入口；下方远端“四按钮验收”和“无缓存入口”仅为来源历史，不是本次最终行为。历史设备验证未在本机重复，当前合并验收见docs/audits/2026-09-12-github-merge.md。
